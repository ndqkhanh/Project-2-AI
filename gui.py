...
class GUI:
    ...
    def __init__(self, parent, chessboard):
        ...
        input.place(x=canvas_width + 20, y=30)

        label = tk.Label(parent, text="File name:")
        label.place(x=canvas_width + 20, y=10)

        button = tk.Button(parent, text="Run")
        button.place(x=canvas_width + 20, y=60)
        self.draw_board()
